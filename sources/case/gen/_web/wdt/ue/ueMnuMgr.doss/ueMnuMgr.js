var ueMnuMgr = {
	...
	/* Localisations */
	fStrings : {en:["menu","",                                                 //0
	            "Hide the menu","Show the menu",                               //2
	            "scroll up","Scroll the menu upwards",                         //4
	            "scroll down","Scroll the menu downwards"],                    //6
	            fr:["menu","",
	            ...
	            es:["menú","",
	            "Esconder el menú","Mostrar el menu",
              "desplazar hacia arriba","Desplazar el menú hacia arriba",
              "desplazar hacia abajo","Desplazar el menú hacia abajo"]
	            },
	...
	onLoad : function() {
		try{
			...
			var vSrlUpBtn = this.xAddBtn(this.fSrlUp, this.fClsPre+"SrlUpBtn", this.xGetStr(4), this.xGetStr(5));
			...
			var vSrlDwnBtn = this.xAddBtn(this.fSrlDwn, this.fClsPre+"SrlDwnBtn", this.xGetStr(6), this.xGetStr(7));
		...
		} catch(e){scCoLib.util.logError("ERROR ueMnuMgr.onLoad",e)}
	},
	loadSortKey : "AZ",
	...
	closeToc : function(){
		...
		if (this.fTglBtn) { //The toggle button may not be created yet
			...
			this.fTglBtn.title = this.xGetStr(3);
		}
	},
	openToc : function(){
		...
		if (this.fTglBtn) { //The toggle button may not be created yet
			...
			this.fTglBtn.title = this.xGetStr(2);
		}
	},
...
scSiRuleEnsureVisible.prototype.ensureVis = function() {
	...
	} catch(e) {scCoLib.util.logError("ERROR scSiRuleEnsureVisible.ensureVis"+e)}
}
