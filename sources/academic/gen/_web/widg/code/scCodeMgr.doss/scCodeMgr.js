...
scCodeMgr.onLoad = function() {
	//scCoLib.util.log("scCodeMgr.onLoad");
...
scCodeMgr.xBtnMgr = function(pBtn) {
	//scCoLib.util.log("scCodeMgr.xBtnMgr: "+pBtn.fName);
	var vObj = pBtn.fObj;
	switch(pBtn.fName){
...
scCodeMgr.xInitCodes = function(pCo) {
	//scCoLib.util.log("scCodeMgr.xInitCodes");
...
scCodeMgr.xInitCode = function(pCode,pOpts) {
	//scCoLib.util.log("scCodeMgr.xInitCode");
	try {
//		if (this.xIsVisible(pCode)){
		...
		scCoLib.util.logError("scCodeMgr.xInitCode::Error", e);
	}
}
